<?php
	...
	if($_POST["Envoyer"]==""){
		if(!empty($_POST['nom_c']) && !empty($_POST['email_c']) && !empty($_POST['message_c'])){
			...
			$message_html = "<html><head><link rel='stylesheet' href='". $themeURL ."/css/style.css'></head><style>.im{color:#606161 !important;}span.im {color: red !important;}</style><body style='color:#606161'><div style='background-color:#f5f5f5;margin:0;padding:70px 0 70px 0;width:100%'><img src='". $themeURL ."/images/logo.png' alt='". $titleWebsite ."' style='border:none;display:block; margin:auto; margin-bottom:70px;font-size:14px;font-weight:bold;min-height:auto;line-height:100%;outline:none;text-decoration:none;text-transform:capitalize'><h1 style='color:#ffffff;background-color:#000000;display:block;font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;font-size:20px;font-weight:300;line-height:150%;margin:0;padding:36px 48px;text-align:left'>Vous avez reçu un mail depuis le formulaire contact du site ". $titleWebsite ." de la part de <strong>".$nom."</strong>.</h1><h2 style='color:#000000;display:block;padding: 36px 48px;font-family:Helvetica,Roboto,Arial,sans-serif;font-size:18px;font-weight:bold;line-height:130%;margin:16px 0 8px;text-align:left'>Détails de l'expéditeur: </h2><h4 style='padding: 0px 48px;'><strong>Nom : </strong>".$nom."<br/><strong>Adresse email : </strong><a style='color:#606161' href='".$email."' target='_blank'>".$email."</a><br /><strong>IP de l'auteur : </strong>".$ipsender."<br /></h4><p style='margin-top:20px; padding: 0px 48px; text-align:justify;'>".nl2br(htmlspecialchars($_POST['message_c']))."</p><p style='padding: 48px 0 0 0px; border: 0; color: #000000;font-family: Arial;font-size: 12px;line-height: 125%;text-align: center;'>". $titleWebsite ."</p></div></body></html>";
